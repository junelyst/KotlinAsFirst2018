...
class Tests {
    ...
    @Tag("Normal")
    fun crossPoint() {
        val t = Point(-0.34911098952970343, 0.19153598799892507)
        assertTrue(t.distance(Line(t, 2.220446049250313e-16).crossPoint(Line(t, 0.5806531521201137))) < 1e-5)
        ...
        assertTrue(Point(8.0, 3.0).distance(Line(Point(0.0, 3.0), 0.0).crossPoint(Line(Point(5.0, 0.0), PI / 4))) < 1e-5)
        assertTrue(Point(4.0, 2.0).distance(Line(Point(4.0, 3.0), PI / 2).crossPoint(Line(Point(2.0, 4.0), 3 * PI / 4))) < 1e-5)
        assertTrue(Point(4.0, 6.0).distance(Line(Point(4.0, 3.0), PI / 2).crossPoint(Line(Point(4.0, 6.0), PI / 6))) < 1e-5)
    }
    ...
    fun bisectorByPoints() {
        ...
        assertApproxEquals(Line(Point((0.4478824257580756 + -2.220446049250313e-16) / 2, -5e-324 / 2), 1.5707963267948966),
                bisectorByPoints(Point(0.4478824257580756, -5e-324), Point(-2.220446049250313e-16, 0.0)))
    }
    ...
    fun minContainingCircle() {
        ...
        val res1 = minContainingCircle(
                Point( -632.0,
                        0.3401023145076294),

                Point( 0.17806154550399156,
                        -5e-324
                ),

                Point( 0.03630982049557541,
                        0.868017348609178
                ),

                Point( 0.34738941967845227,
                        0.5485948209775103
                ),

                Point( 2.220446049250313e-16,
                        -5e-324
                ),
                ...
                Point( 0.554129758084088,
                        -632.0
                ),

                Point( 0.86348484619975,
                        0.0
                ),

                Point( 0.15244013577179405,
                        0.0
                ),

                Point( 0.14196780528634623,
                        -632.0
                ),

                Point( 0.08176811981010756,
                        0.7127278501880927
                ),

                Point( 0.9003275714058573,
                ...
                Point( 0.6186444247605024,
                        -632.0
                ),

                Point( 0.27571013317449133,
                        0.3436756687313829
                ),
                ...
                Point( 0.34315133136794695,
                        -5e-324
                ),

                Point( 0.8299166945384068,
                        0.0
                ),

                Point( 0.8015805935082665,
                        -632.0
                ),

                Point( 0.8545450768873347,
                        0.0),

                Point( 0.2551689962830652,
                        0.04238548631629724),

                Point( 0.931228323545256,
                        0.0),

                Point( 0.789415503571208,
                        -2.220446049250313e-16))
        assertEquals(447.29516132995565, res1.radius, 0.02)
        for (x in listOf(   Point(
                -632.0,
                0.3401023145076294),
