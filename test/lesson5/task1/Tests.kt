...
class Tests {
    ...
    @Tag("Normal")
    fun canBuildFrom() {
        assertTrue(canBuildFrom(listOf('c', 'A', 's', 'e'), "Case"))
    ...
    fun findSumOfTwo() {
        ...
        assertEquals(
                Pair(0, 2),
                findSumOfTwo(listOf(0, 3, 10), 10)
        )
        assertEquals(
                Pair(1, 4),
                findSumOfTwo(listOf(0, 11, 3, 10, 12, 9, 18, 99), 23)
        )
        assertEquals(
                Pair(7, 8),
                findSumOfTwo(listOf(
    ...
    fun bagPacking() {
        ...
        assertEquals(
                setOf("15", "1"),
                bagPacking(
                        mapOf("0" to (1 to 149), "1" to (1 to 470), "2" to (399 to 2),
                                "14" to (1 to 2), "15" to (1 to 375), "33" to (1 to 274)),
                        2
                )
        )
    }
